...
import type {
  OneStakerFeature,
  OneStakerFeatureInterface,
} from "../OneStakerFeature";
...
export class OneStakerFeature__factory {
  static readonly abi = _abi;
  static createInterface(): OneStakerFeatureInterface {
    return new utils.Interface(_abi) as OneStakerFeatureInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OneStakerFeature {
    return new Contract(address, _abi, signerOrProvider) as OneStakerFeature;
  }
}
