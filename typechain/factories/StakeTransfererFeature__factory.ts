...
import type {
  ...
  StakeTransfererFeatureInterface,
} from "../StakeTransfererFeature";
...
export class StakeTransfererFeature__factory {
  static readonly abi = _abi;
  static createInterface(): StakeTransfererFeatureInterface {
    return new utils.Interface(_abi) as StakeTransfererFeatureInterface;
  }
  static connect(
    address: string,
