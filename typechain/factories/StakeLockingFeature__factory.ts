...
import type {
  StakeLockingFeature,
  StakeLockingFeatureInterface,
} from "../StakeLockingFeature";
...
export class StakeLockingFeature__factory {
  static readonly abi = _abi;
  static createInterface(): StakeLockingFeatureInterface {
    return new utils.Interface(_abi) as StakeLockingFeatureInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StakeLockingFeature {
    return new Contract(address, _abi, signerOrProvider) as StakeLockingFeature;
  }
}
