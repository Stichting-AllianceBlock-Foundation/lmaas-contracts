...
export interface StakeTransfererFeatureInterface extends utils.Interface {
  functions: {
...
export interface StakeTransfererFeature extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeTransfererFeatureInterface;
