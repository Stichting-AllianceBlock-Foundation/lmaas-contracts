...
export interface StakeTransfererAutoStakeInterface extends utils.Interface {
  functions: {
...
export interface StakeTransfererAutoStake extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeTransfererAutoStakeInterface;
