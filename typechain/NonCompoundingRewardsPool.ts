...
export interface NonCompoundingRewardsPoolInterface extends utils.Interface {
  functions: {
...
export interface NonCompoundingRewardsPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NonCompoundingRewardsPoolInterface;
