...
export interface StakeLockingRewardsPoolMockInterface extends utils.Interface {
  functions: {
...
export interface StakeLockingRewardsPoolMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeLockingRewardsPoolMockInterface;
