...
export interface StakeLockingFeatureInterface extends utils.Interface {
  functions: {
...
export interface StakeLockingFeature extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeLockingFeatureInterface;
