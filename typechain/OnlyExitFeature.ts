...
export interface OnlyExitFeatureInterface extends utils.Interface {
  functions: {
...
export interface OnlyExitFeature extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OnlyExitFeatureInterface;
