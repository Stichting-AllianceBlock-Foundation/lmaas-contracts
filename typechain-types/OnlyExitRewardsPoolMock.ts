...
export interface OnlyExitRewardsPoolMockInterface extends utils.Interface {
  functions: {
...
export interface OnlyExitRewardsPoolMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OnlyExitRewardsPoolMockInterface;
