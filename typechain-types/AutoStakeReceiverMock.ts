...
export interface AutoStakeReceiverMockInterface extends utils.Interface {
  functions: {
...
export interface AutoStakeReceiverMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AutoStakeReceiverMockInterface;
