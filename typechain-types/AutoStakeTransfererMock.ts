...
export interface AutoStakeTransfererMockInterface extends utils.Interface {
  functions: {
...
export interface AutoStakeTransfererMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AutoStakeTransfererMockInterface;
