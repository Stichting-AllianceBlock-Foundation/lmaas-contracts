...
export interface LimitedAutoStakeInterface extends utils.Interface {
  functions: {
...
export interface LimitedAutoStake extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LimitedAutoStakeInterface;
