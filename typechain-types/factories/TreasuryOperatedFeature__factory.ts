...
import type {
  ...
  TreasuryOperatedFeatureInterface,
} from "../TreasuryOperatedFeature";
...
export class TreasuryOperatedFeature__factory {
  static readonly abi = _abi;
  static createInterface(): TreasuryOperatedFeatureInterface {
    return new utils.Interface(_abi) as TreasuryOperatedFeatureInterface;
  }
  static connect(
    address: string,
