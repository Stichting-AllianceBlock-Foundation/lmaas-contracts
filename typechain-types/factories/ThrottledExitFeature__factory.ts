...
import type {
  ...
  ThrottledExitFeatureInterface,
} from "../ThrottledExitFeature";
...
export class ThrottledExitFeature__factory {
  static readonly abi = _abi;
  static createInterface(): ThrottledExitFeatureInterface {
    return new utils.Interface(_abi) as ThrottledExitFeatureInterface;
  }
  static connect(
    address: string,
