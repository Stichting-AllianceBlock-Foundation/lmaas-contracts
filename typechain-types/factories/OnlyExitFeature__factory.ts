...
import type {
  OnlyExitFeature,
  OnlyExitFeatureInterface,
} from "../OnlyExitFeature";
...
export class OnlyExitFeature__factory {
  static readonly abi = _abi;
  static createInterface(): OnlyExitFeatureInterface {
    return new utils.Interface(_abi) as OnlyExitFeatureInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OnlyExitFeature {
    return new Contract(address, _abi, signerOrProvider) as OnlyExitFeature;
  }
}
