...
import type {
  ...
  StakeReceiverFeatureInterface,
} from "../StakeReceiverFeature";
...
export class StakeReceiverFeature__factory {
  static readonly abi = _abi;
  static createInterface(): StakeReceiverFeatureInterface {
    return new utils.Interface(_abi) as StakeReceiverFeatureInterface;
  }
  static connect(
    address: string,
