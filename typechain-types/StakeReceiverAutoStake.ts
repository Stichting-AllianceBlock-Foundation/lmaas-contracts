...
export interface StakeReceiverAutoStakeInterface extends utils.Interface {
  functions: {
...
export interface StakeReceiverAutoStake extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeReceiverAutoStakeInterface;
