...
export interface RewardsPoolBaseInterface extends utils.Interface {
  functions: {
...
export interface RewardsPoolBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RewardsPoolBaseInterface;
