...
export interface CompoundingRewardsPoolInterface extends utils.Interface {
  functions: {
...
export interface CompoundingRewardsPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundingRewardsPoolInterface;
