...
export interface ThrottledExitRewardsPoolMockInterface extends utils.Interface {
  functions: {
...
export interface ThrottledExitRewardsPoolMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThrottledExitRewardsPoolMockInterface;
